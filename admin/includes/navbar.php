...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="../index/index.php" class="logo">
            ...
            <span class="logo-mini"><b>P&V</b></span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>P&V</b> Logistique</span>
        </a>
        ...
        <nav class="navbar navbar-static-top">
            ...
            <?php $tableau = executeRequete("SELECT * FROM demandes"); ?>
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <span class="hidden-xs"><?php echo $_SESSION['membre']['nom'] . '&nbsp;' . $_SESSION['membre']['prenom'] ?></span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
                            <li class="user-header">
                                ...
                                <p>
                                    <?php echo $_SESSION['membre']['nom'] . '&nbsp;' . $_SESSION['membre']['prenom'] ?> - Web Developer
                                </p>
                            </li>
                            <!-- Menu Footer-->
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    <a href="#">
                        <i class="fa fa-file-text"></i> <span>Demandes</span>
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <li class="treeview">
                    <a href="#">
                        <i class="fa fa-thumb-tack"></i> <span>Tâches</span>
                        <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
                    </a>
                    <ul class="treeview-menu menu-open" style="display: none;">
                        <li><a href="../produits/gestion_produits.php"><i class="fa fa-cogs"></i> Consulter</a></li>
                    </ul>
                </li>
